...
def seed_kolaborator(user_ids, ref_ids):
    ...
    items = [
        ...
        Kolaborator(
            ...
            alamat_lengkap="Jl. Merdeka No. 10, RT 05/RW 02, Kelurahan Braga, Kecamatan Sumur Bandung",
            latitude=-6.9175,
            longitude=107.6191,
        ...
        Kolaborator(
            ...
            alamat_lengkap="Jl. Sudirman No. 45, RT 03/RW 01, Kelurahan Senayan",
            latitude=-6.2088,
            longitude=106.8456,
        ...
        Kolaborator(
            ...
            alamat_lengkap="Jl. Pahlawan No. 20, Kelurahan Bubutan",
            latitude=-7.2575,
            longitude=112.7521,
...
def seed_aset(user_ids, ref_ids):
    ...
    items = [
        ...
        Aset(
            ...
            status_aktif=True,
            kabupaten_kota="Kota Bandung",
            alamat_lengkap="Jl. Cihampelas No. 88, RT 02/RW 05",
            latitude=-6.8973,
            longitude=107.6059,
            penanggung_jawab="Budi Santoso",
            kontak="+6281234567890",
        ...
        Aset(
            ...
            alamat_lengkap="Jl. Raya Cipatik Km 12, Desa Cipeundeuy",
            latitude=-6.8820,
            longitude=107.4880,
        ...
        Aset(
            ...
            status_aktif=True,
            kabupaten_kota="Kota Surabaya",
            alamat_lengkap="Jl. Darmo Permai No. 5, RT 01/RW 03",
            latitude=-7.2916,
            longitude=112.7317,
            penanggung_jawab="Ahmad Hidayat",
            kontak="+6281122334455",
...
def seed_laporan(user_ids, ref_ids):
    ...
    items = [
        ...
        LaporanSampahIlegal(
            ...
            longitude=106.8450,
            kabupaten_kota="Kota Jakarta Selatan",
            alamat_lokasi="Dekat Pasar Minggu, belakang terminal, samping selokan",
        ...
        LaporanSampahIlegal(
            ...
            longitude=112.7500,
            kabupaten_kota="Kota Surabaya",
            alamat_lokasi="Lahan kosong sebelah Taman Bungkul, Jl. Raya Darmo",
        ...
        LaporanSampahIlegal(
            ...
            longitude=107.6050,
            kabupaten_kota="Kota Bandung",
            alamat_lokasi="Pinggir Jalan Raya Dago",
        ...
        LaporanSampahIlegal(
            ...
            longitude=112.7400,
            kabupaten_kota="Kota Surabaya",
            alamat_lokasi="Samping sungai Kalimas, dekat Jembatan Veteran",
...
def seed_marketplace(user_ids, ref_ids):
    ...
    items = [
        MarketplaceDaurUlang(
            ...
            longitude=107.6191,
            kabupaten_kota="Kota Bandung",
            alamat_lengkap="Jl. Merdeka No. 10, Kelurahan Braga",
        ...
        MarketplaceDaurUlang(
            ...
            longitude=106.8456,
            kabupaten_kota="Kota Jakarta Selatan",
            alamat_lengkap="Jl. Sudirman No. 45, Kelurahan Senayan",
            status_ketersediaan=StatusKetersediaan.TERSEDIA,
        ),
        MarketplaceDaurUlang(
        ...
        MarketplaceDaurUlang(
            ...
            longitude=112.7400,
            kabupaten_kota="Kota Surabaya",
            alamat_lengkap="Samping sungai Kalimas, Jl. Veteran",
